...
class Reduction(Loops):
    ...
    def create_multilayer(
        ...
        *,
        ...
        # strict_sum needs the classic lowering's fixed summation order, which the
        # grid path does not reproduce, so it keeps the reshape.
        if config.force_red_split_dim_as_grid_dim and is_triton(device) and not strict_sum:
